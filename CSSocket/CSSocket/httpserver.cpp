...
)
{
	...
	for (;;)
	{
		...
		if (NO_ERROR == result)
		{
			...
			// Worked! 
			// 
			PSTR str = "<!DOCTYPE html><html><body><form action=\"/socket/\" method=\"post\">From:<br><input type=\"text\" name=\"from\" value=\"qhy123qhy.sss.com\"><br>To:<br><input type=\"text\" name=\"to\" value=\"123456@qq.com\"><br>主题:<br><input type=\"text\" name=\"subject\" value=\"主题\"><br>邮件内容:<br> <textarea rows=\"10\" cols=\"30\" name=\"body\">这是一封邮件!</textarea> <br><input type=\"submit\" value=\"Submit\"></form> </body></html>";
...
)
{
	...
	if (pRequest->Flags & HTTP_REQUEST_FLAG_MORE_ENTITY_BODY_EXISTS)
	{
		...
		if (hTempFile == INVALID_HANDLE_VALUE)
		{
			...
			UrlDecode(pEntityBuffer, BytesRead);
			if(result == NO_ERROR){}
			...
			if (BytesRead != 0)
			{
				...
				emailTool((char *)pEntityBuffer, (int)TotalBytesRead);
